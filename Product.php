    ...
    echo '<div class="container-fluid" id="books">
        <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:rgb(228, 55, 25);text-transform:uppercase;margin-bottom:0px;"> '. $category .' COURSES </h2>
           </div>
        </div>      
        <div class="container fluid">
             <div class="row">
                       ...
                       <form action="';echo $_SERVER['PHP_SELF'];echo'" method="post" class="pull-right">
                           <label for="sort">Sort by &nbsp: &nbsp</label>
                            <select name="sort" id="select" onchange="form.submit()">
                                ...
                                <option value="price" name="newest"> Newest </option>
                                <option value="priceh" name="date"> Date published </option>
                                <option value="discountl" name="popular"> Most Popular </option>
                                <option value="discount" name="discount">Oldest</option>
                            </select>
                       </form>
                  </div>
              </div>
